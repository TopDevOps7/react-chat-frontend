                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    const userSpecialPermissions = specialPermissionList.find(
                      (specialPermssion) => specialPermssion.userId && paramCase(specialPermssion.userId) === id
                    );
                    const displayRole =
                      ...
                      >
                        ...
                        <TableCell component="th" align="left" style={{ padding: '0' }}>
                          <Typography
                            ...
                            noWrap
                            component={RouterLink}
                            to={`${PATH_DASHBOARD.user.root}/${paramCase(id.toString())}/details`}
                        ...
                        <TableCell align="right">
                          <UserMoreMenu onDelete={() => onDeleteUser(id)} userName={name} userId={id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
